      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            <h2 className="text-2xl font-serif font-bold tracking-widest mb-6">IEVA SIBILLA<span className="text-brand-yellow">.</span></h2>
          ...
          <div>
            <h4 className="text-sm font-bold uppercase tracking-widest mb-6 text-brand-yellow">Explore</h4>
          ...
          <div>
             <h4 className="text-sm font-bold uppercase tracking-widest mb-6 text-brand-yellow">Resources</h4>
             <ul className="space-y-4 text-sm text-gray-400">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/10 text-xs text-gray-600">
            ...
            <p>Designed with <span className="text-brand-yellow">♥</span> for Founders.</p>
        </div>
      </div>
    </footer>
  );
